...
function App() {
    ...
    <section className="bg-white dark:bg-zinc-900/40 border border-zinc-300 dark:border-zinc-800 rounded-xl overflow-hidden shadow-sm">
      ...
      <div className="p-5 space-y-6">
        ...
        <div className="bg-zinc-50 dark:bg-zinc-900/50 rounded-lg p-4 border border-zinc-200 dark:border-zinc-700">
          <h3 className="text-xs font-semibold text-zinc-600 dark:text-zinc-400 uppercase tracking-wide mb-3">{t('optimize.ternary_chart', 'Ternary Weight Chart')}</h3>
          <TernaryPlot
  ...
  const renderAdvancedConstraints = () => (
    <>
      <section className="bg-white dark:bg-zinc-900/40 border border-zinc-300 dark:border-zinc-800 rounded-xl overflow-hidden shadow-sm">
        <div className="p-4 border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/60 flex items-center gap-2">
